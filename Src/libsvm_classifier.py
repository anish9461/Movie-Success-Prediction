...
class SVMClassifier:
    ...
    def __init__(self, data, keyword, trainingDataFile, classifierDumpFile, trainingRequired = 0):
        ...
        self.helper = ClassifierHelper.ClassifierHelper(os.getcwd()+'/Data/General/feature_list.txt')
    ...
    def classify(self):
        ...
        for i in self.tweets:
            ...
            p_labels, p_accs, p_vals = svm_predict([1] * len(test_feature_vector),\
    ...
    def printResults(self, source, fig_num):
        ...
        title = None
        outfile_path = path.abspath(os.getcwd()+'/Results/SVM/'+ self.keyword + ' '+ source + '.pdf')
