...
class KeywordClassifier:
    ...
    def classify(self):
        ...
        inpfile = open(os.getcwd()+'/Data/KeywordClassifierData/pos_mod.txt', "r")            
        ...
        inpfile = open(os.getcwd()+'/Data/KeywordClassifierData/neg_mod.txt', "r")            
        line = inpfile.readline()
        negative_words = []
        while line:
        ...
        for i in self.processedData:
            ...
            self.results[i] = res
        #end outer loop   
        filename = os.getcwd()+'/Data/KeywordClassifierData/results_lastweek.pickle'
    ...
    def printResults(self, source, fig_num):
        ...
        title = None
        outfile_path = path.abspath(os.getcwd()+'/Results/KeywordClassifier/'+ self.keyword+' ' + source + '.pdf')
