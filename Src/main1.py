...
if (IOHelper.checkIfFileExists(os.getcwd()+'//Data//TwitterDataContainer', key_word + '.csv')):
    print "Data already present !! Skipping data fetch from twitter"
    
    twitter_data[0] = IOHelper.readCsvToStringList(os.getcwd()+'//Data//TwitterDataContainer//'+ key_word + '.csv')
...
# check if data is already present or should be fetched
# if (IOHelper.checkIfFileExists(os.getcwd()+'/Data/YouTubeDataContainer', key_word + '.csv')):
#     print "Data already present !! Skipping data fetch from YouTube"
#     youTube_data[0] = IOHelper.readCsvToStringList(os.getcwd()+'/Data/YouTubeDataContainer/'+ key_word + '.csv')
...
#     print "Completed fetching YouTube comments !!",youTube_data[0]
...
if( not is_tweet_from_file):
    IOHelper.writeStringListToCsv(os.getcwd()+'//Data//TwitterDataContainer//'+ key_word + '.csv', twitter_data[0])
...
trainingDataFile = os.getcwd()+'/Data/SVM/trimmed_training_dataset_2000.csv'
classifierDumpFile = os.getcwd()+'/Data/SVM/svm_test_model.pickle'
trainingRequired = 0
...
trainingDataFile = os.getcwd()+'/Data/NaiveBayes/full_training_dataset.csv'
# Here we can use some other training data set - shortened for speeding process.
classifierDumpFile = os.getcwd()+'/Data/NaiveBayes/naivebayes_test_model.pickle'
